...
import { LayoutDashboard, Terminal, Dumbbell, BookOpen, Utensils, Moon, Smile, CheckCircle, Target, Video, Users, Swords, Calendar, Trophy, History, Settings, LogOut, ShoppingBag } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const progStudy = { value: Math.min(100, (studyMinutes / 120) * 100), label: 'Minutes', color: 'var(--rank-alpha)' };
      ...
      <aside className={`${styles.sidebar} ${sidebarOpen ? styles.open : ''}`}>
        ...
        <nav className={styles.nav} onClick={handleNavClick}>
          ...
          <div style={{ cursor: 'pointer', marginTop: 'auto' }} onClick={handleLogout}>
            <div className={styles.item} style={{ color: 'var(--color-red)' }}>
